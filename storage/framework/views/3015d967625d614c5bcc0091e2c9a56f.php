        ...
        >
            ...
            <div class="gallery-footer" x-data="{ itemDrag : false }">
                ...
                <div class="flex gap-x-2 justify-self-end" style="margin-right: 1.5rem;">
                    ...
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($hasCustomPropertiesAction()): ?>
...
<?php /**PATH /Users/noamany/Desktop/untitled folder 2/projects/MuGaber/7aseeb/Formado Admin panel/resources/views/vendor/gallery-json-media/forms/content/gallery-content.blade.php ENDPATH**/ ?>